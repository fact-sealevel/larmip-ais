...
@click.option("--scaling-coefficients-dir", type=str, default=None, required=True)
@click.option(
    "--r-functions-dir",
    type=str,
    default=None,
