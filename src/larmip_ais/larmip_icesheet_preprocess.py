...
def GetSATData(fname, scenario, refyear_start, refyear_end, year_start, year_end):
    # Open the file
...
def larmip_preprocess_icesheet(
    scenario, pipeline_id, fname, refyear_start, refyear_end, year_start, year_end
):
    # Load the temperature data
    SAT, Time, NumTensemble = GetSATData(
        fname, scenario, refyear_start, refyear_end, year_start, year_end
    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the preprocessing stage for the LARMIP icesheet module",
    ...
    # Run the larmip code
    larmip_preprocess_icesheet(
        pipeline_id=args.pipeline_id,
        scenario=args.scenario,
        fname=args.climate_data_file,
    )
