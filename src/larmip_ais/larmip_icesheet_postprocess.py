...
def larmip_postprocess_icesheet(
    ...
    ncvar_attributes = {
        "description": "Local SLR contributions from icesheets according to LARMIP2 workflow",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the post-processing stage for the LARMIP icesheet module",
